...
public class PlaneWireframe extends WireframeEntity{
	
	private static Vector3f[] vertices = {new Vector3f(1, 0, 1), 
										  new Vector3f(1, 0, -1), 
										  new Vector3f(-1, 0, -1), 
										  new Vector3f(-1, 0, 1)};

	public PlaneWireframe(Vector3f position, Vector3f scale, Vector3f color) {
		super(new WireframeModel(generateModelVAO(), 8), position, scale, color);
	}
